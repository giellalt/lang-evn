...
This directory contains source files for the Evenki language morphology
...
In order to compile and use Evenki language morphology and dictionaries,
you need:
...
The Evenki language sources can be acquired using [giella SVN
